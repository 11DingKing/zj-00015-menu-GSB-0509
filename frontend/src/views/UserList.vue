      ...
      <table class="table">
        ...
        <tbody>
          <tr v-for="user in users" :key="user.id">
            ...
            <td>
              <span
                :class="user.status === 1 ? 'tag tag-success' : 'tag tag-error'"
              >
                {{ user.status === 1 ? "启用" : "禁用" }}
              </span>
            </td>
            <td>
              ...
              <button
                v-permission="'system:user:grantRole'"
                class="btn btn-default btn-sm"
                style="margin-right: 4px"
              ...
              <button
                v-permission="'system:user:grantPerm'"
                class="btn btn-default btn-sm"
                style="margin-right: 4px"
    ...
    >
      <div class="modal">
        ...
        <div class="modal-body">
          ...
          <div class="form-item">
            <label class="form-label" :class="{ required: !isEdit }"
              >密码</label
            >
            <input
        ...
        <div class="modal-footer">
          <button class="btn btn-default" @click="modalVisible = false">
            取消
          </button>
          <button
            class="btn btn-primary"
